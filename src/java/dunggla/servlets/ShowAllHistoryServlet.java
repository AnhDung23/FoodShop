...
public class ShowAllHistoryServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            dao.showAllBills(username);
            List<BillDTO> list = dao.getList();
            request.setAttribute("LIST", list);
            url = SEARCH_PAGE;
        }catch(NamingException e){
            log("ShowAllHistorryServlet_NamingException " + e.getMessage());
        }catch(SQLException e){
            log("ShowAllHistorryServlet_SQLException " + e.getMessage());
        } finally {
